...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Block.template_block'
        db.alter_column('selfpublish_block', 'template_block_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.TemplateBlock'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Block.template_block'
        db.alter_column('selfpublish_block', 'template_block_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['selfpublish.TemplateBlock']))
