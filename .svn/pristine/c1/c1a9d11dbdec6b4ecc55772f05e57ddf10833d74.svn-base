...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageCount.encrypted_key'
        db.add_column('selfpublish_pagecount', 'encrypted_key',
                      self.gf('django.db.models.fields.CharField')(default='L41YPz2Ase0y1TrZLq3UUpD6iVcsOV4ZADw5Vg4BTaA=', max_length=44),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PageCount.encrypted_key'
        db.delete_column('selfpublish_pagecount', 'encrypted_key')
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'unlock_key': ('django.db.models.fields.CharField', [], {'default': "'733cab23-f49b-49d1-8a0b-4297f490dd43'", 'max_length': '36'}),
