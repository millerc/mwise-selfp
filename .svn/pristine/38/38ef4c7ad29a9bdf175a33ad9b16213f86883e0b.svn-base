...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpreadTemplate.type'
        db.add_column('selfpublish_spreadtemplate', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.SpreadType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SpreadTemplate.type'
        db.delete_column('selfpublish_spreadtemplate', 'type_id')
