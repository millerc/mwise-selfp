...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.approved'
        db.add_column('selfpublish_ad', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DisplayAd.content'
        db.alter_column('selfpublish_displayad', 'content', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Lead.status'
        db.alter_column('selfpublish_lead', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.LeadStatusType'], null=True, on_delete=models.SET_NULL))
    def backwards(self, orm):
        # Deleting field 'Ad.approved'
        db.delete_column('selfpublish_ad', 'approved')


        # Changing field 'DisplayAd.content'
        db.alter_column('selfpublish_displayad', 'content', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100))

        # Changing field 'Lead.status'
        db.alter_column('selfpublish_lead', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.LeadStatusType'], null=True))
    models = {
        'auth.group': {
        ...
        'selfpublish.ad': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'c23ee49f-4c97-4f51-84a0-4b7457dc3db2'", 'max_length': '36'}),
        ...
        'selfpublish.lead': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_code': ('django.db.models.fields.CharField', [], {'default': "'ed584ea2-872d-4aff-8891-0a8b5da949d8'", 'max_length': '36'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'organization': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'publication': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['selfpublish.Publication']"}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['selfpublish.LeadStatusType']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'selfpublish.publication': {
            ...
            'progress_bar': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'setup_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'4c762424-915e-4058-b160-58e71d6dd182'", 'max_length': '36'}),
