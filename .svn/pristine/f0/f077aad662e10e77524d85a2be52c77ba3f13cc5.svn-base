...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.progress_bar'
        db.add_column('selfpublish_layout', 'progress_bar',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Layout.progress_bar'
        db.delete_column('selfpublish_layout', 'progress_bar')
    ...
    models = {
        ...
        'selfpublish.layout': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'progress_bar': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
