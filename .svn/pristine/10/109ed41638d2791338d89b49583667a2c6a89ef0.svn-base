...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Publication.theme'
        db.add_column('selfpublish_publication', 'theme', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.Theme']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Publication.theme'
        db.delete_column('selfpublish_publication', 'theme_id')
