...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.unlocked'
        db.delete_column('selfpublish_publication', 'unlocked')

        # Deleting field 'Publication.unlock_key'
        db.delete_column('selfpublish_publication', 'unlock_key')

        # Adding field 'Publication.setup_key'
        db.add_column('selfpublish_publication', 'setup_key',
                      self.gf('django.db.models.fields.CharField')(default='e9f15af8-2fb5-4204-a7aa-1851cb900ee0', max_length=36),
                      keep_default=False)

        # Adding field 'Publication.setup_done'
        db.add_column('selfpublish_publication', 'setup_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Publication.unlocked'
        db.add_column('selfpublish_publication', 'unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Publication.unlock_key'
        db.add_column('selfpublish_publication', 'unlock_key',
                      self.gf('django.db.models.fields.CharField')(default='733cab23-f49b-49d1-8a0b-4297f490dd43', max_length=36),
                      keep_default=False)

        # Deleting field 'Publication.setup_key'
        db.delete_column('selfpublish_publication', 'setup_key')

        # Deleting field 'Publication.setup_done'
        db.delete_column('selfpublish_publication', 'setup_done')
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'7aa8d815-f0aa-40ba-b793-98eb73ca9d16'", 'max_length': '36'}),
