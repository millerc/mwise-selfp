...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CharBlock.template_char_block'
        db.alter_column('selfpublish_charblock', 'template_char_block_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.TemplateCharBlock'], null=True))

        # Changing field 'CharBlock.content'
        db.alter_column('selfpublish_charblock', 'content', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Adding field 'Block.template_block'
        db.add_column('selfpublish_block', 'template_block', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['selfpublish.TemplateBlock']), keep_default=False)

        # Adding field 'Block.filled'
        db.add_column('selfpublish_block', 'filled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'CharBlock.template_char_block'
        db.alter_column('selfpublish_charblock', 'template_char_block_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['selfpublish.TemplateCharBlock']))

        # Changing field 'CharBlock.content'
        db.alter_column('selfpublish_charblock', 'content', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Deleting field 'Block.template_block'
        db.delete_column('selfpublish_block', 'template_block_id')

        # Deleting field 'Block.filled'
        db.delete_column('selfpublish_block', 'filled')
    ...
    models = {
        ...
        'selfpublish.charblock': {
            ...
            'template_char_block': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['selfpublish.TemplateCharBlock']", 'null': 'True', 'blank': 'True'})
        },
        'selfpublish.cover': {
