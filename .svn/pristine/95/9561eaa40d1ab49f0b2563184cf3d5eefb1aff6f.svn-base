...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageCount.minimum_articles'
        db.add_column('selfpublish_pagecount', 'minimum_articles', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.maximum_articles'
        db.add_column('selfpublish_pagecount', 'maximum_articles', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.advertisments'
        db.add_column('selfpublish_pagecount', 'advertisments', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.listings'
        db.add_column('selfpublish_pagecount', 'listings', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.revenue'
        db.add_column('selfpublish_pagecount', 'revenue', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.minimum_membership'
        db.add_column('selfpublish_pagecount', 'minimum_membership', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PageCount.maximum_membership'
        db.add_column('selfpublish_pagecount', 'maximum_membership', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageCount.minimum_articles'
        db.delete_column('selfpublish_pagecount', 'minimum_articles')

        # Deleting field 'PageCount.maximum_articles'
        db.delete_column('selfpublish_pagecount', 'maximum_articles')

        # Deleting field 'PageCount.advertisments'
        db.delete_column('selfpublish_pagecount', 'advertisments')

        # Deleting field 'PageCount.listings'
        db.delete_column('selfpublish_pagecount', 'listings')

        # Deleting field 'PageCount.revenue'
        db.delete_column('selfpublish_pagecount', 'revenue')

        # Deleting field 'PageCount.minimum_membership'
        db.delete_column('selfpublish_pagecount', 'minimum_membership')

        # Deleting field 'PageCount.maximum_membership'
        db.delete_column('selfpublish_pagecount', 'maximum_membership')
    ...
    models = {
        ...
        'selfpublish.pagecount': {
            ...
            'advertisments': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
