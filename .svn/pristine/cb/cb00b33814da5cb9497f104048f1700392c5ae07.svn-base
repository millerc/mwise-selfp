...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageCount.decrypted_key'
        db.add_column('selfpublish_pagecount', 'decrypted_key',
                      self.gf('django.db.models.fields.CharField')(default='OTB00-UNBX000', max_length=13),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PageCount.decrypted_key'
        db.delete_column('selfpublish_pagecount', 'decrypted_key')
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'9f856800-9f76-4c91-b30f-300cc89a40ca'", 'max_length': '36'}),
