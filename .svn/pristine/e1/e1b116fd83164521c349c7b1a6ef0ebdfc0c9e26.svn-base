...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.progress_bar'
        db.add_column('selfpublish_publication', 'progress_bar',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Publication.progress_bar'
        db.delete_column('selfpublish_publication', 'progress_bar')
