...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageCount.setup_fee'
        db.add_column('selfpublish_pagecount', 'setup_fee',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1595),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PageCount.setup_fee'
        db.delete_column('selfpublish_pagecount', 'setup_fee')
