...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Image'
        db.create_table('selfpublish_image', (
        ...
        db.send_create_signal('selfpublish', ['Image'])

        # Adding model 'File'
        db.create_table('selfpublish_file', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('selfpublish', ['File'])


    def backwards(self, orm):
        
        # Deleting model 'Image'
        db.delete_table('selfpublish_image')

        # Deleting model 'File'
        db.delete_table('selfpublish_file')
