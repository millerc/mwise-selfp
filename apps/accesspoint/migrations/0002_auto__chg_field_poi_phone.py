...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'POI.phone'
        db.alter_column('accesspoint_poi', 'phone', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))


    def backwards(self, orm):
        
        # Changing field 'POI.phone'
        db.alter_column('accesspoint_poi', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
