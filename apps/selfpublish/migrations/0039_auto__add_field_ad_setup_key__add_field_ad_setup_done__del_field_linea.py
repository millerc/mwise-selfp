...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.setup_key'
        db.add_column('selfpublish_ad', 'setup_key',
                      self.gf('django.db.models.fields.CharField')(default='a138460c-1330-46c3-9f9d-8a251e80be9d', max_length=36),
                      keep_default=False)

        # Adding field 'Ad.setup_done'
        db.add_column('selfpublish_ad', 'setup_done',
    ...
    def backwards(self, orm):
        # Deleting field 'Ad.setup_key'
        db.delete_column('selfpublish_ad', 'setup_key')

        # Deleting field 'Ad.setup_done'
        db.delete_column('selfpublish_ad', 'setup_done')
        ...
        db.add_column('selfpublish_linead', 'setup_key',
                      self.gf('django.db.models.fields.CharField')(default='b6602873-3f90-4eca-b6d4-594b9498f40f', max_length=36),
                      keep_default=False)
    ...
    models = {
        ...
        'selfpublish.ad': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'9d3194f6-a4c4-4613-9925-5be3b066f4b2'", 'max_length': '36'}),
        ...
        'selfpublish.publication': {
            ...
            'progress_bar': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'setup_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'9ae4d875-efd7-462b-8acb-c33e9177feea'", 'max_length': '36'}),
