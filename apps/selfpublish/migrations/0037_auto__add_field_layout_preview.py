...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('selfpublish_layout', 'preview',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Layout.preview'
        db.delete_column('selfpublish_layout', 'preview')
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'ac078bdb-f51f-4702-ae19-8640b088ba53'", 'max_length': '36'}),
