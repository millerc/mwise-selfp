...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.unlock_url'
        db.delete_column('selfpublish_publication', 'unlock_url')

        # Adding field 'Publication.unlock_key'
        db.add_column('selfpublish_publication', 'unlock_key',
                      self.gf('django.db.models.fields.CharField')(default='7e4028f6-e0b1-4a72-8f8c-0228cc6cf9b3', max_length=36),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Publication.unlock_url'
        db.add_column('selfpublish_publication', 'unlock_url',
                      self.gf('django.db.models.fields.CharField')(default='cb16185c-9f57-4b66-8d29-ace76e243cb4', max_length=36),
                      keep_default=False)
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'unlock_key': ('django.db.models.fields.CharField', [], {'default': "'76117fbe-f349-4894-98d1-362c7f15fc8f'", 'max_length': '36'}),
