...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LeadStatusType'
        db.create_table('selfpublish_leadstatustype', (
            ('statustype_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.StatusType'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('selfpublish', ['LeadStatusType'])

        # Adding field 'Lead.status'
        db.add_column('selfpublish_lead', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.LeadStatusType'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Lead.note'
        db.alter_column('selfpublish_lead', 'note', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):
        ...
        # Deleting model 'LeadStatusType'
        db.delete_table('selfpublish_leadstatustype')

        # Deleting field 'Lead.status'
        db.delete_column('selfpublish_lead', 'status_id')


        # Changing field 'Lead.note'
        db.alter_column('selfpublish_lead', 'note', self.gf('django.db.models.fields.TextField')(default='empty'))
    models = {
        'auth.group': {
        ...
        'selfpublish.publication': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'c43badaf-35ce-41dc-a268-00a2557c4116'", 'max_length': '36'}),
