...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.slug'
        db.add_column('selfpublish_template', 'slug', self.gf('django.db.models.fields.SlugField')(default='XXX_000', max_length=7, db_index=True), keep_default=False)

        # Adding field 'Theme.slug'
        db.add_column('selfpublish_theme', 'slug', self.gf('django.db.models.fields.SlugField')(default='THM_000_VAR_000', max_length=15, db_index=True), keep_default=False)

        # Changing field 'Theme.description'
        db.alter_column('selfpublish_theme', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Template.slug'
        db.delete_column('selfpublish_template', 'slug')

        # Deleting field 'Theme.slug'
        db.delete_column('selfpublish_theme', 'slug')

        # Changing field 'Theme.description'
        db.alter_column('selfpublish_theme', 'description', self.gf('django.db.models.fields.TextField')(default='Description not supplied.'))
