...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Publication.page_count' to match new field type.
        db.rename_column('selfpublish_publication', 'page_count', 'page_count_id')
        # Changing field 'Publication.page_count'
        db.alter_column('selfpublish_publication', 'page_count_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.PageCount']))

        # Adding index on 'Publication', fields ['page_count']
        db.create_index('selfpublish_publication', ['page_count_id'])


    def backwards(self, orm):
        
        # Removing index on 'Publication', fields ['page_count']
        db.delete_index('selfpublish_publication', ['page_count_id'])

        # Renaming column for 'Publication.page_count' to match new field type.
        db.rename_column('selfpublish_publication', 'page_count_id', 'page_count')
        # Changing field 'Publication.page_count'
        db.alter_column('selfpublish_publication', 'page_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
