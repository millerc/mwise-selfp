...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('selfpublish', ['Lead'])

        # Adding field 'Ad.lead'
        db.add_column('selfpublish_ad', 'lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.Lead'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Ad.user'
        db.alter_column('selfpublish_ad', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'AdPriceLevel.code'
        db.alter_column('selfpublish_adpricelevel', 'code', self.gf('django.db.models.fields.CharField')(max_length=16))
    def backwards(self, orm):
        # Deleting model 'LeadStatus'
        db.delete_table('selfpublish_leadstatus')

        # Deleting model 'Lead'
        db.delete_table('selfpublish_lead')

        # Deleting field 'Ad.lead'
        db.delete_column('selfpublish_ad', 'lead_id')


        # Changing field 'Ad.user'
        db.alter_column('selfpublish_ad', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'AdPriceLevel.code'
        db.alter_column('selfpublish_adpricelevel', 'code', self.gf('django.db.models.fields.CharField')(max_length=12))
    models = {
        'auth.group': {
        ...
        'selfpublish.leadstatus': {
            'Meta': {'object_name': 'LeadStatus', '_ormbases': ['core.StatusType']},
        ...
        'selfpublish.publication': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'c53d92be-7e52-433c-8f7f-13f77040b1f8'", 'max_length': '36'}),
