...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FileBlock.content'
        db.delete_column('selfpublish_fileblock', 'content')

        # Deleting field 'FileBlock.byline'
        db.delete_column('selfpublish_fileblock', 'byline')

        # Adding field 'FileBlock.file'
        db.add_column('selfpublish_fileblock', 'file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.File'], null=True, blank=True), keep_default=False)

        # Deleting field 'ImageBlock.credit'
        db.delete_column('selfpublish_imageblock', 'credit')

        # Deleting field 'ImageBlock.content'
        db.delete_column('selfpublish_imageblock', 'content')

        # Deleting field 'ImageBlock.caption'
        db.delete_column('selfpublish_imageblock', 'caption')

        # Adding field 'ImageBlock.image'
        db.add_column('selfpublish_imageblock', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.Image'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FileBlock.content'
        db.add_column('selfpublish_fileblock', 'content', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'FileBlock.file'
        db.delete_column('selfpublish_fileblock', 'file_id')
        ...
        # Adding field 'ImageBlock.content'
        db.add_column('selfpublish_imageblock', 'content', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'ImageBlock.image'
        db.delete_column('selfpublish_imageblock', 'image_id')
