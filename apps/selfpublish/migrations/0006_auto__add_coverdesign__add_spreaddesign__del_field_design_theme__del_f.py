...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CoverDesign'
        db.create_table('selfpublish_coverdesign', (
            ('design_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['selfpublish.Design'], unique=True, primary_key=True)),
            ('theme', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['selfpublish.Theme'], unique=True)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.CoverTemplate'])),
        ))
        db.send_create_signal('selfpublish', ['CoverDesign'])

        # Adding model 'SpreadDesign'
        db.create_table('selfpublish_spreaddesign', (
            ('design_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['selfpublish.Design'], unique=True, primary_key=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.Theme'])),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.SpreadTemplate'])),
        ))
        db.send_create_signal('selfpublish', ['SpreadDesign'])

        # Deleting field 'Design.theme'
        db.delete_column('selfpublish_design', 'theme_id')

        # Deleting field 'Design.template'
        db.delete_column('selfpublish_design', 'template_id')


    def backwards(self, orm):
        
        # Deleting model 'CoverDesign'
        db.delete_table('selfpublish_coverdesign')

        # Deleting model 'SpreadDesign'
        db.delete_table('selfpublish_spreaddesign')

        # Adding field 'Design.theme'
        db.add_column('selfpublish_design', 'theme', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.Theme']), keep_default=False)

        # Adding field 'Design.template'
        db.add_column('selfpublish_design', 'template', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.Template']), keep_default=False)
