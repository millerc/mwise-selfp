...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LineAd.setup_key'
        db.add_column('selfpublish_linead', 'setup_key',
                      self.gf('django.db.models.fields.CharField')(default='62fceb73-9def-41df-b21c-05d81ca87953', max_length=36),
                      keep_default=False)

        # Adding field 'LineAd.setup_done'
        db.add_column('selfpublish_linead', 'setup_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'LineAd.category'
        db.alter_column('selfpublish_linead', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['selfpublish.LineAdCategory'], null=True))

        # Changing field 'LineAd.logo'
        db.alter_column('selfpublish_linead', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    def backwards(self, orm):
        # Deleting field 'LineAd.setup_key'
        db.delete_column('selfpublish_linead', 'setup_key')

        # Deleting field 'LineAd.setup_done'
        db.delete_column('selfpublish_linead', 'setup_done')


        # Changing field 'LineAd.category'
        db.alter_column('selfpublish_linead', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.LineAdCategory']))

        # Changing field 'LineAd.logo'
        db.alter_column('selfpublish_linead', 'logo', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
    models = {
        'auth.group': {
        ...
        'selfpublish.linead': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'b6602873-3f90-4eca-b6d4-594b9498f40f'", 'max_length': '36'})
        },
        ...
        'selfpublish.publication': {
            ...
            'progress_bar': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'setup_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'c8a4fd68-0b13-40b3-bb48-0e68f32d33b7'", 'max_length': '36'}),
