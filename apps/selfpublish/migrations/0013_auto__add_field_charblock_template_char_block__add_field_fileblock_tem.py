...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CharBlock.template_char_block'
        db.add_column('selfpublish_charblock', 'template_char_block', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.TemplateCharBlock']), keep_default=False)

        # Adding field 'FileBlock.template_file_block'
        db.add_column('selfpublish_fileblock', 'template_file_block', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.TemplateFileBlock']), keep_default=False)

        # Adding field 'ImageBlock.template_image_block'
        db.add_column('selfpublish_imageblock', 'template_image_block', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.TemplateImageBlock']), keep_default=False)

        # Deleting field 'Block.template_block'
        db.delete_column('selfpublish_block', 'template_block_id')


    def backwards(self, orm):
        
        # Deleting field 'CharBlock.template_char_block'
        db.delete_column('selfpublish_charblock', 'template_char_block_id')

        # Deleting field 'FileBlock.template_file_block'
        db.delete_column('selfpublish_fileblock', 'template_file_block_id')

        # Deleting field 'ImageBlock.template_image_block'
        db.delete_column('selfpublish_imageblock', 'template_image_block_id')

        # Adding field 'Block.template_block'
        db.add_column('selfpublish_block', 'template_block', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['selfpublish.TemplateBlock']), keep_default=False)
