...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cover.publication'
        db.add_column('selfpublish_cover', 'publication', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['selfpublish.Publication'], unique=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('selfpublish_publication', 'cover', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['selfpublish.Cover'], unique=True), keep_default=False)

        # Deleting field 'Cover.publication'
        db.delete_column('selfpublish_cover', 'publication_id')
