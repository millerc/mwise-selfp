...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.blocks_text'
        db.add_column('selfpublish_template', 'blocks_text',
                      self.gf('django.db.models.fields.TextField')(default='No Blocks'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Template.blocks_text'
        db.delete_column('selfpublish_template', 'blocks_text')
