...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageCount.advertisements'
        db.add_column('selfpublish_pagecount', 'advertisements', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageCount.advertisements'
        db.delete_column('selfpublish_pagecount', 'advertisements')
