...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.paid'
        db.add_column('selfpublish_ad', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Ad.paid'
        db.delete_column('selfpublish_ad', 'paid')
    ...
    models = {
        ...
        'selfpublish.ad': {
            ...
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'ed38ec87-0ca9-4d80-a84a-31a32cd1a762'", 'max_length': '36'}),
        ...
        'selfpublish.lead': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_code': ('django.db.models.fields.CharField', [], {'default': "'dcc79202-4c82-4988-93c4-c51e728a737a'", 'max_length': '36'}),
        ...
        'selfpublish.publication': {
            ...
            'progress_bar': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'setup_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'setup_key': ('django.db.models.fields.CharField', [], {'default': "'1a2cd08b-80e1-4c61-b3cf-7c8a4e2b4cc5'", 'max_length': '36'}),
