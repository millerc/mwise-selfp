...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('selfpublish_publication', 'unlock_url',
                      self.gf('django.db.models.fields.CharField')(default='3e572807-c039-4f28-9add-c8f2e88f7598', max_length=36),
                      keep_default=False)
    ...
    models = {
        ...
        'selfpublish.publication': {
            ...
            'unlock_url': ('django.db.models.fields.CharField', [], {'default': "'cb16185c-9f57-4b66-8d29-ace76e243cb4'", 'max_length': '36'}),
